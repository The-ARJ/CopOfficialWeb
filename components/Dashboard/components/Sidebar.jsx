...
import { FaCalendar, FaNewspaper, FaSuitcase, FaUser } from "react-icons/fa";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      <div className="lg:py-6.5 flex items-center justify-between gap-2 px-6 py-5.5">
        <Link href="/dashboard">
          <div className=" text-3xl font-medium text-white">CopOfficial</div>
        </Link>
