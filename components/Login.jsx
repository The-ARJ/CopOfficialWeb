...
function LoginBar({ state, setState }) {
  ...
  return (
    <div
      className={`fixed top-0 bottom-0 p-2 w-full lg:w-[400px] overflow-y-auto text-center bg-[#334155] transition-all ease-in-out duration-500 ${
        styles.sidebar
